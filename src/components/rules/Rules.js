        ...
        {" "}
          ...
          <Modal.Body className="rules-text">
            ...
            <p className="rules-text">
              ...
              someone guess Bond, just like Riiiiiinnng or SMS are allowed to
              help someone guess Telephone, and $ is allowed to help someone
              guess America.
            </p>
            <p className="rules-text">
              Invalid clues:
            ...
            <p className="rules-text">
              ...
              two steps: First an API cancels all clues that are certainly
              invalid or have been submitted several times. In a second step,
              all the submitted clues are displayed to all the clue givers and
              each one can report invalid clues and duplicates. If several
              players choose the same clues to be invalid respectively
              duplicates, they also get cancelled.
            </p>
            <p className="rules-text">
              Identical clues:
              <ul>
            ...
            <p className="rules-text">
              ...
              the active player. Nevertheless, he may submit a guess or just
              skip it.
            </p>
